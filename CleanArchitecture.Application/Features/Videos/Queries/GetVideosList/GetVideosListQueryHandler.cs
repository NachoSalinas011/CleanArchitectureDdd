...
{
    public class GetVideosListQueryHandler : IRequestHandler<GetVideosListQuery, List<VideosVm>> // request, result
    {
        private readonly IVideoRepository _videoRepository; //Inyección de la interfaz
